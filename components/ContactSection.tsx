...
export default function ContactSection() {
  ...
  return (
    <>
      <section
        id="contact"
        className="scroll-mt-32 fade-up border-t border-[var(--border)] pt-24 pb-8"
      >
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
          <div className="flex-1 lg:max-w-md">
            ...
            <p className="text-[var(--muted)] text-base leading-relaxed mb-10">
              Whether you&apos;re looking to build scalable infrastructure,
              real-time data pipelines, or just want to chat about backend
